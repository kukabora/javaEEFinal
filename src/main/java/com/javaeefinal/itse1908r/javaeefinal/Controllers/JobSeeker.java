...
@Path("/jobSeeker")
public class JobSeeker implements ExceptionMapper {
    ...
    public Response getAllBuildings() {
        List<Building> buildings = buildingService.getAllBuildingsByCategoryName("JobSeeker");
    ...
    public Response getCategory() {
        return Response.ok().entity(categoryService.getCategoryByName("JobSeeker").getDescription()).build();
    }
